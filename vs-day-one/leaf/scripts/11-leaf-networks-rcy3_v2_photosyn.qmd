---
title: "Automatic import files to Cytoscape and color network (photosynthesis)"
format: html
date: "2025-11-15"
...
```{r format all}
clusters <- vector("list", length = 9)

for (i in c(1, 3, 4, 5, 6, 8, 10, 12, 13)) {
  input_file=paste0("../results/network/cluster_", i, "_400_photosyn.txt")
...
# However - in both leaf and SAM in vs-day-one input to this script don't have such cases - filtered-out in script 10-...qmd.
...
createNetworkFromDataFrames(
  ...
  collection="leaf networks - photosynth",
  nodes=node.info_srt,
