...
The aim of this code is to prepare files (clustering results and String network data [@szklarczykSTRINGDatabase20232023]) for Cytoscape analysis and visualization. Separately for each cluster.
...
c13_m1.35_mem07 <- c13_m1.35_desc |>
  filter(
...
c13_m1.35_maxmem <- data.frame(
  ...
  max_mem     = max_mem,
  description = c13_m1.35_mem07$description,
