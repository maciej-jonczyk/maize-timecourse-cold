---
title: "GO analysis for expression changes in leaf in cold"
format: html
date: "2025-07-08"
...
save(list = ls(pattern = "^gs."), file = "../rdata-saved/goseq-res-leaf1.RDa")
save(list = ls(pattern = "^bh."), file = "../rdata-saved/goseq-bh-res-leaf1.RDa")
