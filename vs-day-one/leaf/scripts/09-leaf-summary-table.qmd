---
title: "Prepare file summarising clustering and GO-enrichment, leaf"
format: html
date: "2025-10-16"
...
# goseq results
load("../rdata-saved/mfuzz_res_for09_leafALLsig.RDa")
...
```{r sig-GOs}
# As the leaf GOs can be enriched in one or several clusters join by "GO id" and "cluster number" is required. GO id alone is not sufficient.
...
library(dplyr)
# Join everything
# Join cluster summary (c13_m1.35_desc) with go_anno
