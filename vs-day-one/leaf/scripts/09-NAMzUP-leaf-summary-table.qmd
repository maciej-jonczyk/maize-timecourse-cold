...
# goseq results
load("../rdata-saved/NAMzUP_mfuzz_res_for09_leafALLsig.RDa")
...
write.table(c13_m1.35_desc, file="../results/go/leaf-cluster-membership.txt", sep="\t", quote=FALSE, row.names=FALSE)
...
library(dplyr)
# Join everything
# Join cluster summary (c13_m1.35_desc) with GO description and gene description
