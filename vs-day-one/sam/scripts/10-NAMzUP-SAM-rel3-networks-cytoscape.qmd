...
:::{.callout-note}
This script uses cluster files generated in [10-NAMzUP-SAM-networks-cytoscape-loop.qmd](10-NAMzUP-SAM-networks-cytoscape-loop.qmd) up to *bash split* chunk.
:::
