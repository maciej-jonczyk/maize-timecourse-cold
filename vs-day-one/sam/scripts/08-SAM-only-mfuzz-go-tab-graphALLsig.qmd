...
# it is for checking usage of GO annotation from UniProt (file `input-data/go/00-GO-and-mapping-UniProt.qmd`)
...
```{r save-for-09}
save(result.goseq, result_clean, expr.go.cats, file="../rdata-saved/mfuzz_res_for09_samALLsig.RDa")
```
...
for sample in ${sample_names[@]}
do
go_plot.py --obo=../../../../../../../input-data/go/go.obo --go_file=${sample} --outfile=../svg/bp/${sample}.svg
done
...
for sample in ${sample_names[@]}
do
go_plot.py --obo=../../../../../../../input-data/go/go.obo --go_file=${sample} --outfile=../svg/cc/${sample}.svg
done
...
for sample in ${sample_names[@]}
do
go_plot.py --obo=../../../../../../../input-data/go/go.obo --go_file=${sample} --outfile=../svg/mf/${sample}.svg
done
```
