---
title: "Automatic import files to Cytoscape and color network - genes annotated to 'developmental' terms"
format: html
date: "2025-11-27"
...
```{r format all}
clusters <- vector("list", length = 10)

for (i in 1:10) {
  input_file=paste0("../results/network/cluster_", i, "_400_dev.txt")
...
createNetworkFromDataFrames(
  ...
  collection="SAM networks - developmental",
  nodes=node.info_srt,
