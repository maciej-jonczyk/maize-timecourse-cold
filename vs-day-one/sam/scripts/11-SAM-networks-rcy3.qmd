...
https://manual.cytoscape.org/en/stable/Programmatic_Access_to_Cytoscape_Features_Scripting.html#cytoscape_automation
...
```{r import}
# load file
cl1 = read.table("../results/network/cluster_1_400_tran-reg.txt", header=TRUE, stringsAsFactors = FALSE, sep='\t', quote = "")
```
...
src=unique(cl1[c('uniprot1', 'ensembl1', 'desc1', 'cluster1', 'member1')])
trg=unique(cl1[c('uniprot2', 'ensembl2', 'desc2', 'cluster2', 'member2')])
...
# EDGE table
edge.info=unique(cl1[,!names(cl1) %in% c('ensembl1', 'desc1', 'cluster1', 'member1', 'ensembl2', 'desc2', 'cluster2', 'member2')])

createNetworkFromDataFrames(
  title="cluster_1_400_tran-reg",
...
setNodeColorBypass(
  t(subset(node.info_srt, cluster == 1, select=c("id"))),
  "#78c679"
)
```
