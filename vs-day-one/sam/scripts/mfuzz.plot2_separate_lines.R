    ...
    Xwidth = 5, Xheight = 5, single = FALSE, ...) 
{
    ...
    for (j in 1:dim(cl[[1]])[[1]]) {
        ...
        rect(xleft=12, ybottom = ymin, xright=13, ytop = ymax, col="white", border="white")
        rect(xleft=24, ybottom = ymin, xright=25, ytop = ymax, col="white", border="white")
        rect(xleft=36, ybottom = ymin, xright=37, ytop = ymax, col="white", border="white")
