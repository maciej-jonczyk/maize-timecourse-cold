---
title: "GO analysis for expression changes in SAM in cold - ALL significant genes"
format: html
date: "2025-12-07"
...
expr.go.cats=read.table("../../../input-data/go-uniprot/SAM.pop", header = FALSE, stringsAsFactors = FALSE)
...
write.table(expressed.genes, file="../results/go/expressed_genes_samALLsig.txt", col.names=FALSE, row.names=FALSE, quote=FALSE)
...
Load the data from the mfuzz analysis for given number of clusters and fuzziness (computed in `07-SAM-only-mfuzzALLsig.qmd`)
...
```{r save-for-09}
save(result.goseq, result.goseq25, result_clean, expr.go.cats, file="../rdata-saved/NAMzUP_mfuzz_res_for09_samALLsig.RDa")
```
...
```{bash compare}
# To previous try withb UniProt
diff ../results/go/graphs/clusters/bp/ ../results/OLD2-go/clusters/bp/
diff ../results/go/graphs/clusters/bp/NAMzUP_Klaster_5.txt.bp ../results/OLD2-go/clusters/bp/NAMzUP_Klaster_5.txt.bp
# 17,18d16
# < GO:0000028
# < GO:0006413
# 19a18,19
...
diff ../results/go/graphs/clusters/cc/ ../results/OLD2-go/clusters/cc/
  
diff ../results/go/graphs/clusters/mf/ ../results/OLD2-go/clusters/mf/
diff ../results/go/graphs/clusters/mf/NAMzUP_Klaster_5.txt.mf ../results/OLD2-go/clusters/mf/NAMzUP_Klaster_5.txt.mf
# 6d5
# < GO:0008017
# 7a7
# > GO:0008017
...
comm --total <(sort ../results/go/graphs/clusters10_1.25ALLsig/bp/Klaster_1.txt.bp) <(sort ../results/go/graphs/clusters/bp/NAMzUP_Klaster_1.txt.bp)

comm --total <(sort ../results/go/graphs/clusters10_1.25ALLsig/bp/Klaster_5.txt.bp) <(sort ../results/go/graphs/clusters/bp/NAMzUP_Klaster_5.txt.bp)

comm --total <(sort ../results/go/graphs/clusters10_1.25ALLsig/bp/Klaster_6.txt.bp) <(sort ../results/go/graphs/clusters/bp/NAMzUP_Klaster_6.txt.bp)

# CC

comm --total <(sort ../results/go/graphs/clusters10_1.25ALLsig/cc/Klaster_1.txt.cc) <(sort ../results/go/graphs/clusters/cc/NAMzUP_Klaster_1.txt.cc)

comm --total <(sort ../results/go/graphs/clusters10_1.25ALLsig/cc/Klaster_5.txt.cc) <(sort ../results/go/graphs/clusters/cc/NAMzUP_Klaster_5.txt.cc)

# MF

comm --total <(sort ../results/go/graphs/clusters10_1.25ALLsig/mf/Klaster_1.txt.mf) <(sort ../results/go/graphs/clusters/mf/NAMzUP_Klaster_1.txt.mf)

comm --total <(sort ../results/go/graphs/clusters10_1.25ALLsig/mf/Klaster_5.txt.mf) <(sort ../results/go/graphs/clusters/mf/NAMzUP_Klaster_5.txt.mf)
