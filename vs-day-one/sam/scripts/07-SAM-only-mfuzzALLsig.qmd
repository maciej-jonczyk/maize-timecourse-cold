...
# it seems that value given by mestimate is good for small number of clusters but too low for 11 and >=13 where minimum m = 1.1 should be used
...
# c_vals = c(10, 12, 13) # Dmin
# m_vals = c(1.25, 1.3) # Dmin

# c_vals = c(12, 24) # Dmin
# m_vals = 1.35 # Dmin

# c_vals = c(13, 17, 26) # Dmin, 17 from cselection
# m_vals = 1.4 # Dmin
