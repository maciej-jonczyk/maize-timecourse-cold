---
title: "Comparison of subsequent time-points to time zero (first day of cold) in SAM"
format: html
date: "2025-07-09"
...
There are four inbred lines so the same analysis must be done for each so there are 36 tests in total.
