...
:::{.callout-note}
There are also annotation from NCBI but it uses geneindex IDs which are inconvenient and their file has less annotations.
Some comparisons of MaizeGAMER (used previously) UniProt and NCBI contents are in [10-SAM-networks-cytoscape.qmd](../../vs-day-one/sam/scripts/10-SAM-networks-cytoscape.qmd) file.
:::
...
:::{.callout-caution}
Move to [OO-test-filter.qmd](OO-test-filter.qmd) file for extracting best UP fo each NAM.
:::
