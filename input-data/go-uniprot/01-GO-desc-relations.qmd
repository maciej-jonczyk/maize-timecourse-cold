...
```{bash cca}
# Manually add CCA1 and two other clock TFs

cd ../../../input-data/go-uniprot/

rm rel3-genes-rhythm-add
cp rel3-genes-rhythm rel3-genes-rhythm-add

echo -e 'Zm00001eb172450\nZm00001eb139830\nZm00001eb362240' >> rel3-genes-rhythm-add
