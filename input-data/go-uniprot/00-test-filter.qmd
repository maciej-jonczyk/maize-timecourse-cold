...
:::{.callout-caution}
This code continues [00-GO-and-mapping-UniProt.qmd](00-GO-and-mapping-UniProt.qmd). And *must* be executed if best NAM-UP pairs are not selected already.
:::
...
# Pliki xbest_string_goa i xbest_string_goa_rev są identyczne
...
:::{.callout-caution}
Return to [00-GO-and-mapping-UniProt.qmd](00-GO-and-mapping-UniProt.qmd) for preparation of files for each analysed dataset (SAM, leaf, ...)
:::
