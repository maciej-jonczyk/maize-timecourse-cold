...
knitr::opts_chunk$set(root.dir = "/media/mj/ANTIX-LIVE/project1-stat/vs-day-two-expr001/sam/scripts")
```
...
load("../rdata-saved/sigs_SAM2-001.RDa")

# Saving results of goseq without BH correction (gs...) and objects after correction (bh...) contain only adjusted p-value
load("../rdata-saved/goseq-res_SAM2-001.RDa")
load("../rdata-saved/goseq-bh-res_SAM2-001.RDa")
...
rm -r sam_a554_001/ sam_s018_001/ sam_s84_001/ sam_s311_001/

# DO ZMIANY - INNE KATALOGI

# Create directories
mkdir -p {sam_a554_001,sam_s018_001,sam_s84_001,sam_s311_001}/{d3,d4}/{t1,t2,t3}

# Move files

mv *a554*sam*.* sam_a554_001/
mv *s018*sam*.* sam_s018_001/
mv *s84*sam*.* sam_s84_001/
mv *s311*sam*.* sam_s311_001/
...
rm -r sam_a554_001/d3/t[12]/

rm -r sam_s018_001/d3/t[13]/
rm -r sam_s018_001/d4/t1/

rm -r sam_s84_001/d3/t3/

rm -r sam_s311_001/d[34]/t3/


# Join files (significant genes) by variant

cat sam_a554_001/d3/t3/de* | sort | tail -n +2 > sam_a554_001/d3/t3/de_a554_d3d2_t3.txt

cat sam_a554_001/d4/t1/de* | sort | tail -n +2 > sam_a554_001/d4/t1/de_a554_d4d2_t1.txt
cat sam_a554_001/d4/t2/de* | sort | tail -n +2 > sam_a554_001/d4/t2/de_a554_d4d2_t2.txt
cat sam_a554_001/d4/t3/de* | sort | tail -n +2 > sam_a554_001/d4/t3/de_a554_d4d2_t3.txt

cat sam_s018_001/d3/t2/de* | sort | tail -n +2 > sam_s018_001/d3/t2/de_s018_d3d2_t2.txt
cat sam_s018_001/d4/t2/de* | sort | tail -n +2 > sam_s018_001/d4/t2/de_s018_d4d2_t2.txt
cat sam_s018_001/d4/t3/de* | sort | tail -n +2 > sam_s018_001/d4/t3/de_s018_d4d2_t3.txt

cat sam_s84_001/d3/t1/de* | sort | tail -n +2 > sam_s84_001/d3/t1/de_s84_d3d2_t1.txt
cat sam_s84_001/d3/t2/de* | sort | tail -n +2 > sam_s84_001/d3/t2/de_s84_d3d2_t2.txt
cat sam_s84_001/d4/t1/de* | sort | tail -n +2 > sam_s84_001/d4/t1/de_s84_d4d2_t1.txt
cat sam_s84_001/d4/t2/de* | sort | tail -n +2 > sam_s84_001/d4/t2/de_s84_d4d2_t2.txt
cat sam_s84_001/d4/t3/de* | sort | tail -n +2 > sam_s84_001/d4/t3/de_s84_d4d2_t3.txt

cat sam_s311_001/d3/t1/de* | sort | tail -n +2 > sam_s311_001/d3/t1/de_s311_d3d2_t1.txt
cat sam_s311_001/d3/t2/de* | sort | tail -n +2 > sam_s311_001/d3/t2/de_s311_d3d2_t2.txt
cat sam_s311_001/d4/t1/de* | sort | tail -n +2 > sam_s311_001/d4/t1/de_s311_d4d2_t1.txt
cat sam_s311_001/d4/t2/de* | sort | tail -n +2 > sam_s311_001/d4/t2/de_s311_d4d2_t2.txt

# Join files (significant GOs) by variant

cat sam_a554_001/d4/t3/sigs* | sort -r | tail -n +2 > sam_a554_001/d4/t3/sigs_a554_d4d2_t3.tsv

cat sam_s84_001/d3/t2/sigs* | sort -r | tail -n +2 > sam_s84_001/d3/t2/sigs_s84_d3d2_t2.tsv
cat sam_s84_001/d4/t2/sigs* | sort -r | tail -n +2 > sam_s84_001/d4/t2/sigs_s84_d4d2_t2.tsv

cat sam_s311_001/d4/t2/sigs* | sort -r | tail -n +2 > sam_s311_001/d4/t2/sigs_s311_d4d2_t2.tsv
```
