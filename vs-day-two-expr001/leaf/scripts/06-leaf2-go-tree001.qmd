---
title: "Draw tree for significant GOs (Biolgical Process class), (expression change p-val<0.01)"
format: html
date: "2025-07-11"
...
original_names <- grep("^bh.*(min|pl)001$", ls(), value = TRUE)
