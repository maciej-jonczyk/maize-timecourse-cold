...
**Include** three clock genes added manually.
...
clusters <- vector("list", length = 5)

# below, list exact numbers of clusters for this category
# watch out for proper category suffix
for (i in c(2,9,11,12,13)) {
  input_file=paste0("../results/network/cluster_", i, "_400_rel3_rhythm_add.txt")
...
createNetworkFromDataFrames(
  ...
  collection="leaf, cold-pairiwse, rhythmic",
  nodes=node.info_srt,
