...
# ../../../vs-day-one/leaf/results/go/expressed_genes_leafALLsig.txt
...
for (nm in names(result_clean)) {
  ...
  fname <- paste0("../results/go/graphs/clusters/all_cats/leaf_", gsub(" ", "_", nm), "summary.txt")
...
for (nm in names(result_clean)) {
  ...
  # file name – eg. "Klaster_13.txt"
  fname <- paste0("../results/go/graphs/clusters/all_cats/leaf_", gsub(" ", "_", nm), ".txt")
