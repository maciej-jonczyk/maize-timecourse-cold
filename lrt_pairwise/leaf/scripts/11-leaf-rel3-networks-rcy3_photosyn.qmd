---
title: "Automatic import files to Cytoscape and color network, cold, leaf, pairwise"
format: html
date: "2026-03-21"
...
*photosynthesis* GO category and descendants (childs) including *part_of* and *regulates* in addition to standard *is_a*.
...
for (i in c(2,3,4,5,8,11,12,13,15)) {
  input_file=paste0("../results/network/cluster_", i, "_400_rel3_photosyn.txt")
...
createNetworkFromDataFrames(
  ...
  collection="leaf, cold-pairiwse, photosynthesis",
  nodes=node.info_srt,
...
colors <- paletteer_dynamic("cartography::orange.pal", 15)
