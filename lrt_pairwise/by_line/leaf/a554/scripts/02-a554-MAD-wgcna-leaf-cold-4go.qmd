---
title: "WGCNA for a554 leaf in cold + regrowth. Part IV - GO analysis for modules."
format: html
date: "2026-06-26"
...
Using modules for choosen *power* and *merge threshold*. The input data was prepared in [02-a554-MAD-wgcna-leaf-cold-3export.qmd](02-a554-MAD-wgcna-leaf-cold-3export.qmd)
...
Using the data from the WGCNA analysis for given power (computed in [02-wgcna-leaf-cold-line4-3export.qmd](02-wgcna-leaf-cold-line4-3export.qmd)) - `genes_modules`
...
for (nm in names(result_clean)) {
  ...
  fname <- paste0("../results/wgcna/go/graphs/clusters/all_cats/leaf_cold_", gsub(" ", "_", nm), "_summary.txt")
...
for (nm in names(result_clean)) {
  ...
  fname <- paste0("../results/wgcna/go/graphs/clusters/all_cats/leaf_cold_", nm, "_go.txt")
