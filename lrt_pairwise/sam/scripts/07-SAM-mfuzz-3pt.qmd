---
title: "Mfuzz clustering of SAM data, minimum 3 significant genes from point by point comparisons."
format: html
date: "2026-03-22"
...
```{r load}
load("../rdata-saved/contr_pair_sam_sig005.RDa")
```
...
original_names = ls(pattern = "sam_sig$")
...
save(vsd.eset.ave.std, file="../rdata-saved/vsd.eset.ave.std.sam_pair_min3pt.RDa")
```
...
c_vals = 13
m_vals = 1.25 #seq(1.15, 1.35, 0.05)


## Uncomment on new session
load("../rdata-saved/vsd.eset.ave.std.sam_pair_min3pt.RDa")
...
cl13_m1.25 <- results[["cl13_m1.25"]]

# this file contains only genes with mem >=0.7
genes_in_clusters <- lapply(1:ncol(cl13_m1.25$membership), function(i) {
  geny <- rownames(cl13_m1.25$membership)[cl13_m1.25$membership[, i] >= 0.7]
  return(geny)
})

# Name clusters
names(genes_in_clusters) <- paste("Klaster", 1:ncol(cl13_m1.25$membership))

save(cl13_m1.25, genes_in_clusters, file="../rdata-saved/mfuzz_cl13_m1.25_sam.RDa")
