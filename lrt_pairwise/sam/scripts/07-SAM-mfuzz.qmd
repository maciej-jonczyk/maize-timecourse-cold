---
title: "Mfuzz clustering of SAM data, ALL significant genes from point by point comparisons."
format: html
date: "2026-03-18"
...
save(vsd.eset.ave.std, file="../rdata-saved/vsd.eset.ave.std.sam_pair.RDa")
```
...
tmpR=partcoef(vsd.random, crange=seq(7, 30, 1), mrange=seq(1.00, 1.45, 0.05))
...
c_vals = c(10 : 15) # Dmin
m_vals = seq(1.15, 1.30, 0.05) # Dmin
