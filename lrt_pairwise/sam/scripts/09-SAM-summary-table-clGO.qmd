...
# goseq results
load("../rdata-saved/mfuzz_res_for09_sam.RDa")
...
write.table(cl13_m1.25_desc, file="../results/go/sam-cluster-membership.txt", sep="\t", quote=FALSE, row.names=FALSE)
...
```{r go-summary}
# Join everything
# Join cluster summary (cl13_m1.25_desc) with GO description and gene description
