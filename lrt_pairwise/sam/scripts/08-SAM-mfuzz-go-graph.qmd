...
## expressed.genes for checking duplication in UP - NAM mapping
# it is available here:
# ../../../vs-day-one/sam/results/go/expressed_genes_samALLsig.txt
...
```{r save-for-09}
save(result.goseq, result.goseq25, result_clean, expr.go.cats, file="../rdata-saved/mfuzz_res_for09_sam.RDa")
```
...
for (nm in names(result_clean)) {
  ...
  fname <- paste0("../results/go/graphs/clusters/all_cats/sam_", gsub(" ", "_", nm), "summary.txt")
...
for (nm in names(result_clean)) {
  ...
  # file name – eg. "Klaster_13.txt"
  fname <- paste0("../results/go/graphs/clusters/all_cats/sam_", gsub(" ", "_", nm), ".txt")
