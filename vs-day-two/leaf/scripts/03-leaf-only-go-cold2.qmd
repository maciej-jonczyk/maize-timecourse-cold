---
title: "GO analysis for expression changes in leaf in cold, comparisons to 2nd day of cold"
format: html
date: "2025-07-09"
...
save(list = ls(pattern = "^gs."), file = "../rdata-saved/goseq-res-leaf2.RDa")
save(list = ls(pattern = "^bh."), file = "../rdata-saved/goseq-bh-res-leaf2.RDa")
