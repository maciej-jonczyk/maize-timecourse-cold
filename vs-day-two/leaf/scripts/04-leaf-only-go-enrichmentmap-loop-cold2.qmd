...
load("../rdata-saved/goseq-res-leaf2.RDa")
...
cat a554/d3/t1/de* | sort | tail -n +2 > a554/d3/t1/de_a554_d3d2_t1.txt
cat a554/d3/t2/de* | sort | tail -n +2 > a554/d3/t2/de_a554_d3d2_t2.txt
cat a554/d3/t3/de* | sort | tail -n +2 > a554/d3/t3/de_a554_d3d2_t3.txt

cat a554/d4/t1/de* | sort | tail -n +2 > a554/d4/t1/de_a554_d4d2_t1.txt
cat a554/d4/t2/de* | sort | tail -n +2 > a554/d4/t2/de_a554_d4d2_t2.txt
cat a554/d4/t3/de* | sort | tail -n +2 > a554/d4/t3/de_a554_d4d2_t3.txt

cat s018/d3/t1/de* | sort | tail -n +2 > s018/d3/t1/de_s018_d3d2_t1.txt
cat s018/d3/t2/de* | sort | tail -n +2 > s018/d3/t2/de_s018_d3d2_t2.txt
cat s018/d3/t3/de* | sort | tail -n +2 > s018/d3/t3/de_s018_d3d2_t3.txt

cat s018/d4/t1/de* | sort | tail -n +2 > s018/d4/t1/de_s018_d4d2_t1.txt
cat s018/d4/t2/de* | sort | tail -n +2 > s018/d4/t2/de_s018_d4d2_t2.txt
cat s018/d4/t3/de* | sort | tail -n +2 > s018/d4/t3/de_s018_d4d2_t3.txt

cat s84/d3/t1/de* | sort | tail -n +2 > s84/d3/t1/de_s84_d3d2_t1.txt
cat s84/d3/t2/de* | sort | tail -n +2 > s84/d3/t2/de_s84_d3d2_t2.txt
cat s84/d3/t3/de* | sort | tail -n +2 > s84/d3/t3/de_s84_d3d2_t3.txt

cat s84/d4/t1/de* | sort | tail -n +2 > s84/d4/t1/de_s84_d4d2_t1.txt
cat s84/d4/t2/de* | sort | tail -n +2 > s84/d4/t2/de_s84_d4d2_t2.txt
cat s84/d4/t3/de* | sort | tail -n +2 > s84/d4/t3/de_s84_d4d2_t3.txt

cat s311/d3/t1/de* | sort | tail -n +2 > s311/d3/t1/de_s311_d3d2_t1.txt
cat s311/d3/t2/de* | sort | tail -n +2 > s311/d3/t2/de_s311_d3d2_t2.txt
cat s311/d3/t3/de* | sort | tail -n +2 > s311/d3/t3/de_s311_d3d2_t3.txt

cat s311/d4/t1/de* | sort | tail -n +2 > s311/d4/t1/de_s311_d4d2_t1.txt
cat s311/d4/t2/de* | sort | tail -n +2 > s311/d4/t2/de_s311_d4d2_t2.txt
cat s311/d4/t3/de* | sort | tail -n +2 > s311/d4/t3/de_s311_d4d2_t3.txt

# Join files (significant GOs) by variant

cat a554/d3/t1/sigs* | sort -r | tail -n +2 > a554/d3/t1/sigs_a554_d3d2_t1.tsv
cat a554/d3/t2/sigs* | sort -r | tail -n +2 > a554/d3/t2/sigs_a554_d3d2_t2.tsv
cat a554/d3/t3/sigs* | sort -r | tail -n +2 > a554/d3/t3/sigs_a554_d3d2_t3.tsv

cat a554/d4/t1/sigs* | sort -r | tail -n +2 > a554/d4/t1/sigs_a554_d4d2_t1.tsv
cat a554/d4/t2/sigs* | sort -r | tail -n +2 > a554/d4/t2/sigs_a554_d4d2_t2.tsv
cat a554/d4/t3/sigs* | sort -r | tail -n +2 > a554/d4/t3/sigs_a554_d4d2_t3.tsv

cat s018/d3/t1/sigs* | sort -r | tail -n +2 > s018/d3/t1/sigs_s018_d3d2_t1.tsv
cat s018/d3/t2/sigs* | sort -r | tail -n +2 > s018/d3/t2/sigs_s018_d3d2_t2.tsv
cat s018/d3/t3/sigs* | sort -r | tail -n +2 > s018/d3/t3/sigs_s018_d3d2_t3.tsv

cat s018/d4/t1/sigs* | sort -r | tail -n +2 > s018/d4/t1/sigs_s018_d4d2_t1.tsv
cat s018/d4/t2/sigs* | sort -r | tail -n +2 > s018/d4/t2/sigs_s018_d4d2_t2.tsv
cat s018/d4/t3/sigs* | sort -r | tail -n +2 > s018/d4/t3/sigs_s018_d4d2_t3.tsv

cat s84/d3/t1/sigs* | sort -r | tail -n +2 > s84/d3/t1/sigs_s84_d3d2_t1.tsv
cat s84/d3/t2/sigs* | sort -r | tail -n +2 > s84/d3/t2/sigs_s84_d3d2_t2.tsv
cat s84/d3/t3/sigs* | sort -r | tail -n +2 > s84/d3/t3/sigs_s84_d3d2_t3.tsv

cat s84/d4/t1/sigs* | sort -r | tail -n +2 > s84/d4/t1/sigs_s84_d4d2_t1.tsv
cat s84/d4/t2/sigs* | sort -r | tail -n +2 > s84/d4/t2/sigs_s84_d4d2_t2.tsv
cat s84/d4/t3/sigs* | sort -r | tail -n +2 > s84/d4/t3/sigs_s84_d4d2_t3.tsv

cat s311/d3/t1/sigs* | sort -r | tail -n +2 > s311/d3/t1/sigs_s311_d3d2_t1.tsv
cat s311/d3/t2/sigs* | sort -r | tail -n +2 > s311/d3/t2/sigs_s311_d3d2_t2.tsv
cat s311/d3/t3/sigs* | sort -r | tail -n +2 > s311/d3/t3/sigs_s311_d3d2_t3.tsv

cat s311/d4/t1/sigs* | sort -r | tail -n +2 > s311/d4/t1/sigs_s311_d4d2_t1.tsv
cat s311/d4/t2/sigs* | sort -r | tail -n +2 > s311/d4/t2/sigs_s311_d4d2_t2.tsv
cat s311/d4/t3/sigs* | sort -r | tail -n +2 > s311/d4/t3/sigs_s311_d4d2_t3.tsv
```
