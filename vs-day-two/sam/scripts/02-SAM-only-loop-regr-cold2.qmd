---
title: "Comparison of regrowth time-points to the last day of cold in SAM"
format: html
date: "2025-07-09"
...
:::{.callout-note}
This analysis builds on the previous computations described in [02-SAM-only-loop-regr-cold.qmd](02-SAM-only-loop-regr-cold.qmd)
:::
...
# save workspace
load("../../../vs-day-one/sam/rdata-saved/deseq_cold_SAM.RDa")
```
...
# saving
save(list = to_save, file="../rdata-saved/sigs-SAM2.RDa")
...
# saving
save(list = to_save, file="../rdata-saved/sigs_all_SAM2.RDa")
```
