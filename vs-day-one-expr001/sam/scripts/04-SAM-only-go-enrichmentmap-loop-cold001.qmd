---
title: "Export of GO analysis for visualisation in EnrichmentMap Cytoscape App - SAM (expression change p-val<0.01)"
format: html
date: "2025-07-15"
...
load("../rdata-saved/sigs_all_SAM1-001.RDa")
...
original_names <- grep("^gs\\.pwf\\.gv\\.de\\..*sam_min001$", ls(), value = TRUE)
...
original_names <- grep("^gs\\.pwf\\.gv\\.de\\..*sam_pl001$", ls(), value = TRUE)
...
# list of names
original_names <- grep("^[as][0-9].*sam_(min|pl)001$", ls(), value = TRUE)
...
original_names <- grep("^[as][0-9].*sam_sig001$", ls(), value = TRUE)
# prefix <- "ist."
...
# Create directories
mkdir -p {sam_a554_001,sam_s018_001,sam_s84_001,sam_s311_001}/{d2,d3,d4}/{t1,t2,t3}
...
rm -r sam_a554_001/d2/
rm -r sam_a554_001/d3/t1

rm -r sam_s018_001/d2
